...
description: >-
  ...
  Contains verified facts for bb, claude, codex, opencode, pi, pi-signed, grok, kimi, cursor, gemini, muse, rovo, omp, and agy.
...
<!-- BB-SOURCE
     ...
     snapshot: native-snapshot/6f0f1399/.agents/skills/harness-adapters/SKILL.md
     fidelity: adapted
-->
